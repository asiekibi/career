        ...
        <div class="flex flex-col min-h-screen">
            ...
            <header class="flex items-center justify-between h-16 px-4 lg:px-6 bg-white dark:bg-background-dark border-b border-gray-200 dark:border-gray-800">
                <div class="flex items-center gap-3">
                    ...
                    <h1 class="text-lg lg:text-xl font-bold text-gray-800 dark:text-white">Portal Student</h1>
                </div>
                
                @if(session('student_id'))
                    <a href="{{ route('portal-login') }}" class="flex items-center gap-2 px-4 py-2 rounded-lg text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors">
