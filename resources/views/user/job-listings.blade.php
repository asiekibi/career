...
<main class="flex-1 p-4 lg:p-8">
    <div class="bg-white dark:bg-background-dark rounded-xl shadow-sm">
        <div class="p-4 lg:p-6 border-b border-gray-200 dark:border-gray-800">
            ...
            <p class="mt-1 text-sm lg:text-base text-gray-600 dark:text-gray-400">Mevcut iş ilanlarını görüntüleyin ve
                başvuru yapın.</p>
        </div>
        ...
        <div class="p-4 lg:p-6">
                    ...
                    <table class="w-full text-sm text-left text-gray-500 dark:text-gray-400">
                        ...
                        <tbody>
                            @forelse($jobListings as $listing)
                                <tr
                                    class="bg-white border-b dark:bg-background-dark/80 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-background-dark/90">
            ...
            <div class="lg:hidden space-y-4">
                @forelse($jobListings as $listing)
                    <div
                        class="bg-white dark:bg-background-dark/50 rounded-lg shadow-sm p-4 border border-gray-200 dark:border-gray-700">
                        <div class="mb-3">
                        ...
                        <div class="text-sm mb-3">
                            ...
                            <p class="mt-1 text-gray-900 dark:text-white">{{ Str::limit($listing->job_description, 150) }}
                            </p>
                        </div>
                ...
                @empty
                    <div
                        class="bg-white dark:bg-background-dark/50 rounded-lg shadow-sm p-8 text-center text-gray-500 dark:text-gray-400">
                        Henüz ilan bulunmuyor.
                    </div>
                @endforelse
            </div>
    ...
    <div class="bg-white dark:bg-background-dark rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto">
        <div class="p-6">
            ...
            <div class="flex justify-between items-center mb-4">
                ...
                <button type="button" onclick="closeJobDetailModal()"
