    ...
    <body class="bg-background-light dark:bg-background-dark font-display text-gray-800 dark:text-gray-200">
        ...
        <div class="flex min-h-screen items-center justify-center px-4">
            <div class="w-full max-w-md space-y-8">
                ...
                <!-- Sertifika Doğrulama Form -->
                <div class="mt-6 tab-content hidden" id="company-certificateForm">
                    <div class="bg-white dark:bg-gray-800 rounded-lg p-4 shadow-sm border border-gray-200 dark:border-gray-700">
                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white mb-4">Sertifika Doğrulama</h3>
                        
                        <!-- Hata mesajı gösterimi -->
                        <div id="certificateErrorMessage" class="hidden mt-4 p-4 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-lg">
                            <p class="text-sm text-red-600 dark:text-red-400" id="certificateErrorText"></p>
                        </div>
                        
                        <form action="{{ route('company-portal.search') }}" class="mt-4 space-y-4" method="POST" id="certificateSearchForm">
                            @csrf

                            <div>
                                <label class="sr-only" for="register_number">Register No</label>
                                <input 
                            ...
                            <div>
                                <button class="group relative flex w-full justify-center rounded-lg border border-transparent bg-primary py-3 px-4 text-sm font-medium text-white hover:bg-primary/90 focus:outline-none focus:ring-2 focus:ring-primary focus:ring-offset-2 dark:focus:ring-offset-background-dark disabled:opacity-50 disabled:cursor-not-allowed" 
                                        type="submit" id="certificateSubmitButton">
                                    Sertifikayı Doğrula
                                </button>
                            </div>
                        </form>
    ...
    <script>
        ...
        function switchTab(tab) {
            ...
            if (tab === 'user') {
                ...
                document.getElementById('company-certificateForm').classList.add('hidden');
                ...
                document.getElementById('company-certificateForm').classList.remove('hidden');
        ...
        // Sertifika doğrulama formu AJAX
        ...
        document.getElementById('certificateSearchForm').addEventListener('submit', function(e) {
            ...
            const form = this;
            const submitButton = document.getElementById('certificateSubmitButton');
            const errorMessage = document.getElementById('certificateErrorMessage');
            ...
            .then(data => {
                if (data.success) {
                    ...
                    window.location.href = `/company-portal/student-cv/${data.student.id}`;
                } else {
